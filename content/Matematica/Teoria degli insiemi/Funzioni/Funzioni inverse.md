...
Abbiamo cioè ricavato la _funzione inversa_ di $f$: a partire dalla [funzione](Funzioni.md#^definizione-funzione) $f$ che esprimeva la dipendenza di $C$ da $K$, data da
...
L'esempio precedente pone quindi il problema di capire quando sia definita la funzione inversa; una semplice riflessione suggerisce che, affinché la funzione inversa sia definita, non devono esistere due valori diversi di $x$ aventi la stessa [immagine](Funzioni.md#^definizione-immagine) $f(x)$, ossia $f$ deve essere [iniettiva](Proprietà%20delle%20funzioni.md#^definizione-iniettivita).

> [!definizione]+ Definizione: funzione inversa
> 
> Data una [funzione iniettiva](Proprietà%20delle%20funzioni.md#^definizione-iniettivita) $f \colon A \to B$, si chiama **funzione inversa di $f$** la [funzione](Funzioni.md#^definizione-funzione)
> 
> $$
