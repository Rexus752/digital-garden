...
La [**matematica**](Matematica/Matematica.md#^definizione-matematica) è una delle mie discipline preferite in assoluto da studiare. Mi ha sempre affascinato fin da quando ero piccolo, motivo per cui molto probabilmente ho fin da subito sviluppato una _forma mentis_ molto più tecnica che artistica/umanistica.

Dico spesso che, in un'altra vita, se non avessi sviluppato la passione per l'[informatica](Informatica.md#^definizione-informatica), quasi certamente sarei finito per studiare matematica. Non che il percorso che ho scelto mi dispiaccia, anzi, l'approccio che ho avuto nei confronti dell'[informatica](Informatica.md#^definizione-informatica) a livello didattico (universitario) è stato particolarmente orientato alla [matematica](Matematica/Matematica.md#^definizione-matematica), cosa che mi ha portato ad apprezzarla ulteriormente.
