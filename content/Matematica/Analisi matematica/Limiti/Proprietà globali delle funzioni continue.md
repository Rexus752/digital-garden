...
> 
> Dato un intervallo%% link %% $I \subseteq \mathbb{R}$ e una [funzione continua](Funzioni%20continue.md#^definizione-funzione-continua) $f \colon I \to \mathbb{R}$, se $f$ ammette [limiti](content/Matematica/Analisi%20matematica/Limiti/_index.md#^definizione-limite) per $x$ che tende agli estremi dell'intervallo%% link %% $I$ e questi [limiti](content/Matematica/Analisi%20matematica/Limiti/_index.md#^definizione-limite) hanno segni opposti, allora esiste un punto%% link %% $x_0 \in I$ tale che $f(x_0) = 0$.
> 
> Inoltre, se $f$ è strettamente monotona%% Link %%, allora questo punto%% link %% $x_0$ è unico.
...
> 
> Data una [funzione continua](content/Matematica/Teoria%20degli%20insiemi/Funzioni/_index.md#^definizione-funzione) e monotona%% link %% $f \colon [a,b] \to \mathbb{R}$, si ha che:
...
> 
> Dato un [sottoinsieme](content/Matematica/Teoria%20degli%20insiemi/_index.md#^definizione-sottoinsieme) non [vuoto](content/Matematica/Teoria%20degli%20insiemi/_index.md#^definizione-insieme-vuoto) $A \subseteq \mathbb{R}$, esistono due [successioni](Limiti%20di%20successioni.md#^definizione-successione) $(x_n)$ e $(y_n)$ in $A$ tali che
> 
> $$
...
> 
> Dato un intervallo%% link %% $I \subseteq R$ e una [funzione continua](Funzioni%20continue.md#^definizione-funzione-continua) $f \colon I \to \mathbb{R}$, quest'ultima è [iniettiva](content/Matematica/Teoria%20degli%20insiemi/Funzioni/_index.md#^definizione-iniettivita) se e solo se è strettamente monotona%% Link %%.
...
> 
> Se una [funzione](content/Matematica/Teoria%20degli%20insiemi/Funzioni/_index.md#^definizione-funzione) $f \colon \text{dom}(f) \to \mathbb{R}$ è [uniformemente continua](Proprietà%20globali%20delle%20funzioni%20continue.md#^definizione-funzione-uniformemente-continua), allora è anche [continua](Funzioni%20continue.md#^definizione-funzione-continua).
...
> 
> Se una [funzione](content/Matematica/Teoria%20degli%20insiemi/Funzioni/_index.md#^definizione-funzione) $f \colon [a,b] \to \mathbb{R}$ è [continua](Funzioni%20continue.md#^definizione-funzione-continua), allora è anche [uniformemente continua](Proprietà%20globali%20delle%20funzioni%20continue.md#^definizione-funzione-uniformemente-continua) in $[a,b]$.
