...
Ci sono alcuni [limiti](Matematica/Analisi%20matematica/Limiti/Limiti.md#^definizione-limite) particolari di cui è sempre noto il loro valore, detti [_limiti notevoli_](Matematica/Analisi%20matematica/Limiti/Limiti%20notevoli.md#^definizione-limite-notevole).

> [!definizione]+ Definizione: limite notevole
> 
> Un **limite notevole** è un [limite](Matematica/Analisi%20matematica/Limiti/Limiti.md#^definizione-limite) di una [forma indeterminata](Matematica/Analisi%20matematica/Limiti/Forme%20indeterminate.md#^definizione-forma-indeterminata), il cui valore è noto e dimostrato, usato come formula pronta per calcolare limiti più complessi senza dover ricorrere ogni volta alla dimostrazione%% link %%.
...
> 
> Vale il seguente [limite notevole](Matematica/Analisi%20matematica/Limiti/Limiti%20notevoli.md#^definizione-limite-notevole):
> 
> $$
...
Questo [limite](Matematica/Analisi%20matematica/Limiti/Limiti.md#^definizione-limite) è una [forma indeterminata](Matematica/Analisi%20matematica/Limiti/Forme%20indeterminate.md#^definizione-forma-indeterminata) del tipo $\dfrac{0}{0}$.
...
> 
> Il problema si riduce quindi allo studio del [limite](Matematica/Analisi%20matematica/Limiti/Limiti.md#^definizione-limite) dell'esponente%% link %% $g(x) \ln f(x)$, che è un prodotto e ricade nella [forma indeterminata algebrica del tipo $0 \cdot \infty$](Matematica/Analisi%20matematica/Limiti/Forme%20indeterminate.md#^definizione-forma-indeterminata-algebrica-del-tipo-0-per-infinito). Questa identità%% link %% costituisce il metodo standard per ricondurre qualsiasi [forma indeterminata esponenziale](Matematica/Analisi%20matematica/Limiti/Forme%20indeterminate.md#^definizione-forma-indeterminata-esponenziale) a una [algebrica](Matematica/Analisi%20matematica/Limiti/Forme%20indeterminate.md#^definizione-forma-indeterminata-algebrica).
...
> 
> Date due [funzioni](Matematica/Teoria%20degli%20insiemi/Funzioni/Funzioni.md#^definizione-funzione) $f, g \colon A \subseteq \mathbb{R} \to \mathbb{R}$ (con $A \ne \emptyset$) e un [punto di accumulazione](Matematica/Teoria%20degli%20insiemi/Funzioni/Topologia%20dei%20reali.md#^definizione-punto-di-accumulazione) $x_0 \in \mathbb{R} \cup \{\pm\infty\}$ per $A$, supposto che esista il [limite](Matematica/Analisi%20matematica/Limiti/Limiti.md#^definizione-limite) $\displaystyle\lim_{x \to x_0} \big( g(x) \ln f(x) \big)$, per il [teorema del limite della funzione composta](Matematica/Analisi%20matematica/Limiti/Limiti%20delle%20funzioni%20composte.md#^teorema-del-limite-della-funzione-composta) e il [teorema del limite della funzione composta continua](Matematica/Analisi%20matematica/Limiti/Limiti%20delle%20funzioni%20composte.md#^teorema-del-limite-della-funzione-composta-continua) e per la continuità di $e$%% link alla continuità di $e$ %%, si ha che:
> 
> $$
...
> $$
> 
> Per ipotesi esiste il [limite](Matematica/Analisi%20matematica/Limiti/Limiti.md#^definizione-limite) $\displaystyle\lim_{x \to x_0} \big( g(x) \ln f(x) \big) = \displaystyle\lim_{x \to x_0} \varphi(x) = l$, con $l \in\mathbb{R} \cup \{ \pm \infty \}$. Analizziamo ogni possibile caso in cui può ricadere $l$:
> - $l \in \mathbb{R}$: poiché $h(t) = e^t$ è continua su $\mathbb{R}$%% link alla continuità di $e$ %%, per il [teorema del limite della funzione composta continua](Matematica/Analisi%20matematica/Limiti/Limiti%20delle%20funzioni%20composte.md#^teorema-del-limite-della-funzione-composta-continua) abbiamo che
> 	$$
> 	\lim_{x \to x_0} h(\varphi(x)) = h \left( \lim_{x \to x_0} \varphi(x) \right) = h(l) = e^l
> 	$$
> - $l = +\infty$: per definizione di limite infinito%% link %%, per ogni $M > 0$ esiste un [intorno](Matematica/Teoria%20degli%20insiemi/Funzioni/Topologia%20dei%20reali.md#^definizione-intorno-di-un-punto) $I(x_0)$ tale che $\varphi(x) > M$ per ogni $x \in (A \cap I(x_0)) \setminus {x_0}$. Poiché $h(t) = e^t$ è strettamente crescente e $\displaystyle\lim_{t \to +\infty} e^t = +\infty$, si ha $e^{\varphi(x)} > e^M$ per ogni tale $x$, e poiché $e^M \to +\infty$ al crescere di $M$, si conclude
> 	$$
> 	\lim_{x \to x_0} e^{\varphi(x)} = +\infty
> 	$$
> - $l = -\infty$: analogamente, per ogni $\varepsilon > 0$ esiste un [intorno](Matematica/Teoria%20degli%20insiemi/Funzioni/Topologia%20dei%20reali.md#^definizione-intorno-di-un-punto) $I(x_0)$ tale che $\varphi(x) < -M$ per ogni $x \in (A \cap I(x_0)) \setminus {x_0}$, con $M > 0$ arbitrariamente grande. Poiché $\displaystyle\lim_{t \to -\infty} e^t = 0^+$, si ha $0 < e^{\varphi(x)} < e^{-M}$ per ogni tale $x$, e poiché $e^{-M} \to 0$ al crescere di $M$, si conclude
> 	$$
...
> 
> Se durante la [risoluzione delle forme indeterminate esponenziali](Matematica/Analisi%20matematica/Limiti/Limiti%20notevoli.md#^proposizione-risoluzione-delle-forme-indeterminate-esponenziali) abbiamo che la base%% link %% $f(x)$ è uguale a $1$ in tutto un [intorno bucato](Matematica/Teoria%20degli%20insiemi/Funzioni/Topologia%20dei%20reali.md#^definizione-intorno-bucato-di-un-punto) di $x_0$, allora il [limite](Matematica/Analisi%20matematica/Limiti/Limiti.md#^definizione-limite)
> 
> $$
> \lim_{x \to x_0} [f(x)]^{g(x)}
> $$
> 
> **non** è una [forma indeterminata esponenziale del tipo $1^\infty$](Matematica/Analisi%20matematica/Limiti/Forme%20indeterminate.md#^definizione-forma-indeterminata-espnenziale-del-tipo-1-all-infinito). Infatti, in tal caso,
> 
> $$
...
Tralasciamo la dimostrazione%% link %% di [questo teorema](Matematica/Analisi%20matematica/Limiti/Limiti%20notevoli.md#^teorema-limite-notevole-di-eulero) che non è per nulla banale. Tuttavia, possiamo facilmente intuire che questo [limite](Matematica/Analisi%20matematica/Limiti/Limiti.md#^definizione-limite) è una [forma indeterminata esponenziale del tipo $1^\infty$](Matematica/Analisi%20matematica/Limiti/Forme%20indeterminate.md#^definizione-forma-indeterminata-espnenziale-del-tipo-1-all-infinito).
...
%%
Da questo [limite notevole](Matematica/Analisi%20matematica/Limiti/Limiti%20notevoli.md#^definizione-limite-notevole) ne derivano altri: FARE LISTA
%%
