...
[Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) è il punto d'ingresso a un _rabbit hole_ in cui sono cascato ormai anni fa e da cui non ne sono più uscito, complice anche il fatto che da [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) deriva il [sistema operativo _NixOS_](content/Informatica/Sistemi%20operativi/NixOS/_index.md#^definizione-nixos) che è tutt'ora il sistema operativo%% link %% che principalmente uso.

Un buon punto di partenza per capire cos'è esattamente [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) e come funziona tutto il suo ecosistema sono le [_Nix Pills_](https://nixos.org/guides/nix-pills/), una serie di tutorial pensati per spiegare [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) in modo progressivo. Molti dei contenuti delle note riguardanti [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) nel mio Giardino Digitale sono presi dalle [_Nix Pills_](https://nixos.org/guides/nix-pills/).

Non spiegherò qui nei dettagli come installare [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) (per quello c'è la [documentazione ufficiale](https://nix.dev/install-nix#install-nix)), ma piuttosto preferisco spiegarti cos'è e perché dovresti usarlo.

# Introduzione a Nix

Ok, [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) è un package manager%% link %%, ma cos'ha di speciale? Perché dovrei usarlo? Te lo spiego subito.
...
> 
> dove:
> - **`<hash>`** è una stringa che identifica univocamente la [derivazione](content/Informatica/Nix/_index.md#^definizione-derivazione) e
> - **`<nome>`** è il nome della [derivazione](content/Informatica/Nix/_index.md#^definizione-derivazione).
...
Ciò significa che [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) non lavora direttamente sui pacchetti%% link %%, ma su come ottenere quei pacchetti%% link %% dal loro codice sorgente%% link %%.

> [!attenzione] Attenzione: _derivazione_ e _pacchetto_ come sinonimi
> 
> Pur non essendo esattamente la stessa cosa, in queste note potrei usare per comodità i termini [_derivazione_](content/Informatica/Nix/_index.md#^definizione-derivazione) e _pacchetto_%% link %% come sinonimi.

%% 
Fai attenzione poi alla caratteristica delle [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione) di essere _immutabili_: più tardi la analizzeremo meglio.
 %%
...
- isolamento: ogni derivazione è isolata dall'altra
	...
	- L'isolamento permette anche di avere più versioni dello stesso pacchetto, che normalmente sarebbe difficile da ottenere con i package manager tradizionali. Ciò risolve il [problema dell'interferenza tra dipendenze](Distribuzione%20del%20software.md#^problema-dell-interferenza-tra-dipendenze), perché [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) ci permette di avere due versioni separate delle stesse [dipendenze](Informatica.md#^definizione-dipendenze-di-un-software) per i diversi [software](Informatica.md#^definizione-hardware-e-software) che le richiedono.
...
Le [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione) sono raccolte nel [_Nix store_](content/Informatica/Nix/_index.md#^definizione-nix-store) (dove il termine _store_ va inteso non come _negozio_, ma come _deposito_).

> [!definizione] Definizione: Nix store
> 
> Il **Nix store** è una cartella del [sistema operativo](Sistemi%20operativi.md#^definizione-sistema-operativo) (solitamente `/nix/store`) in cui [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) memorizza tutte le [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione) al suo interno.
^definizione-nix-store

> [!esempio] Esempio di derivazione nel Nix store
> 
> Prendiamo come esempio una [derivazione](content/Informatica/Nix/_index.md#^definizione-derivazione) di bash%% link %% contenuta nel [Nix store](content/Informatica/Nix/_index.md#^definizione-nix-store):
> 
> ```
...
> ```
> 
> Ogni volta che vorremo usare il programma%% link %% bash%% link %%, dovremo far riferimento a questo binario%% link %% presente nel [Nix store](content/Informatica/Nix/_index.md#^definizione-nix-store).

Ovviamente, per rendere questi programmi comodi da usare%% link %%, [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) si occupa di far comparire i binari%% link %% nel tuo `PATH`%% link %% nel modo appropriato.

Ciò evita anche il problema di avere pacchetti%% link %% sparsi per tutto il file system%% link %%: se stiamo cercando un pacchetto%% link %% (o meglio, in questo caso una [derivazione](content/Informatica/Nix/_index.md#^definizione-derivazione), sappiamo che la troveremo sicuramente nel [Nix store](content/Informatica/Nix/_index.md#^definizione-nix-store)).

%% 
![615](Pasted%20image%2020260117015358.png)
%%

In sostanza, quello che abbiamo è un archivio (il [Nix store](content/Informatica/Nix/_index.md#^definizione-nix-store)) di tutti i pacchetti (sotto forma di [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione)), a volte anche con versioni multiple ma distinte (grazie all'univocità%% link %% della [derivazione](content/Informatica/Nix/_index.md#^definizione-derivazione)).

> [!osservazione] Osservazione: comportamento di Nix con le dipendenze
> 
> Come si comporta [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) per le [dipendenze](Informatica.md#^definizione-dipendenze-di-un-software)? [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) si assicura di collegare a ogni [derivazione](content/Informatica/Nix/_index.md#^definizione-derivazione) le proprie [dipendenze](Informatica.md#^definizione-dipendenze-di-un-software), a loro volta gestite tramite altre [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione).
> 
> Mi spiego meglio: facciamo finta che io stia usando bash%% link %% con la versione 5.2.26 che ha come dipendenza glibc%% link %% versione 2.42. Grazie all'indipendenza tra le [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione), posso decidere di usare nello stesso [sistema operativo](Sistemi%20operativi.md#^definizione-sistema-operativo) anche bash%% link %% 5.2.27 che ha come dipendenza glibc%% link %% versione 2.43. Allo stesso modo, potrei usare contemporaneamente un modulo%% link %% di Python 2.7%% link %% compilato con gcc 4.6%% link %% e lo stesso modulo%% link %% ma scritto in Python 3%% link %% compilato con gcc 4.8%% link %%.
> 
> In altre parole, [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) offre solo [dipendenze](Informatica.md#^definizione-dipendenze-di-un-software) "dirette" da una [derivazione](content/Informatica/Nix/_index.md#^definizione-derivazione) a un'altra [derivazione](content/Informatica/Nix/_index.md#^definizione-derivazione).

Insomma, [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) ti permette di usare pacchetti%% link %% e [configurazioni](Sistemi%20operativi.md#^definizione-configurazione-di-un-sistema-operativo) in modo isolato, riproducibile e senza conflitti e gestendo più versioni dello stesso [software](Informatica.md#^definizione-hardware-e-software) contemporaneamente. Rappresenta un _deus ex machina_ per chi ha sempre voluto un [sistema](Sistemi%20operativi.md#^definizione-sistema-operativo) in cui la gestione di pacchetti%% link %% e delle loro [dipendenze](Informatica.md#^definizione-dipendenze-di-un-software) non sono un incubo.

> [!definizione] Definizione: package manager Nix
> 
> **Nix** è un package manager%% link %% per sistemi UNIX-like%% link %%, ideato dallo sviluppatore nederlandese Eelco Dolstra%% link %%, in cui ogni pacchetto%% link %% è rappresentato da una [derivazione](content/Informatica/Nix/_index.md#^definizione-derivazione) che determina come costruirlo%% link %% e il cui risultato viene memorizzato nel [Nix store](content/Informatica/Nix/_index.md#^definizione-nix-store) che garantisce isolamento, immutabilità e univocità delle [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione) stesse.
...
> 
> [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) sta ai pacchetti%% link %% come linguaggi a basso livello%% link %% come il C%% link %% stanno alla memoria%% link %%:
> - come "contenitore", al posto della RAM%% link %%, abbiamo lo spazio sul disco%% link %%;
> - come oggetti su cui operare, anziché variabili%% link %%, abbiamo le [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione);
> - per accedere a questi oggetti, anziché indirizzi%% link %%, abbiamo i percorsi%% link %% delle [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione);
> - per riferirsi a questi oggetti, anziché usare i puntatori%% link %%, accediamo alle [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione) tramite i loro percorsi%% link %% e, al posto dei dangling pointer%% link %%, abbiamo percorsi%% link %% che fanno riferimenti a [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione) inesistenti;
> - per manipolare questi riferimenti, anziché l'aritmetica dei puntatori%% link %%, abbiamo le operazioni su stringhe che rappresentano i percorsi%% link %% delle [derivazioni](content/Informatica/Nix/_index.md#^definizione-derivazione);
...
La lista dei pacchetti%% link %% che [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix) ha a disposizione è contenuta nel [_Nixpkgs_](content/Informatica/Nix/_index.md#^definizione-nixpkgs).

> [!definizione] Definizione: Nixpkgs
> 
> Il **Nixpkgs** (pronuncia: _Nix packages_%% pronuncia IPA %%) è la collezione di pacchetti%% link %% disponibili per il package manager [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix).
> 
...
[Nixpkgs](content/Informatica/Nix/_index.md#^definizione-nixpkgs), al momento in cui sto scrivendo questa nota (gennaio 2026), è il repository%% link %% di pacchetti%% link %% più grande al momento, con oltre 120.000 pacchetti%% link %% disponibili.%% AGGIUNGERE FONTE %%

I pacchetti%% link %% all'interno del [Nixpkgs](content/Informatica/Nix/_index.md#^definizione-nixpkgs) sono divisi in [_canali_](content/Informatica/Nix/_index.md#^definizione-canale).

> [!definizione] Definizione: canale
> 
> In [Nix](content/Informatica/Nix/_index.md#^definizione-package-manager-nix), un **canale** è una collezione di determinate versioni%% link %% dei pacchetti%% link %% disponibili nel [Nixpkgs](content/Informatica/Nix/_index.md#^definizione-nixpkgs).
^definizione-canale
...
> 
> I [canali](content/Informatica/Nix/_index.md#^definizione-canale) possono generare alcuni problemi: [computer](Informatica.md#^definizione-computer) diversi potrebbero usare [canali](content/Informatica/Nix/_index.md#^definizione-canale) diversi (oppure stessi [canali](content/Informatica/Nix/_index.md#^definizione-canale)) e, di conseguenza, non avere a disposizione le stesse versioni%% Link %% degli stessi pacchetti%% link %%.
> 
> Questo problema viene risolto attraverso i _flake_%% link %%.

%% 
Lo script contenuto nella [derivazione](content/Informatica/Nix/_index.md#^definizione-derivazione) per costruire un pacchetto è chiamato solitamente `default.nix` e rappresenta una funzioneLINK che prende le [dipendenze](Informatica.md#^definizione-dipendenze-di-un-software) come argomentoLINK e installa un [software](Informatica.md#^definizione-hardware-e-software) come specificato.
