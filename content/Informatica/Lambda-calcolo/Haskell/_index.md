...
> 
> **Haskell** è un linguaggio di programmazione%% link %% puramente funzionale%% link %% [lazy](content/Informatica/Lambda-calcolo/_index.md#^definizione-ordine-normale), general-purpose%% link %%%% e fortemente tipizzato%% link %%, creato da un apposito comitato alla fine degli anni ottanta%% principalmente per analizzare le caratteristiche dei linguaggi%% link %%. È stato chiamato così in onore del matematico e logico statunitense Haskell Curry%% link %%.
^definizione-haskell
